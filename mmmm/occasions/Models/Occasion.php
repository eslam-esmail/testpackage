...
class Occasion extends OlahubAdminModel {
...
//        'description' => "max:4000|json",
    ...
    public function country() {
        return $this->belongsToMany('OlaHub\Models\Country','country_occasion_types','occasion_type_id','country_id')->withPivot('is_published')->as('country');
    }
}
