...
class GroupsController extends OlaHubAdminController {

    public function __construct(Request $request) {
        parent::__construct($request, 'OlaHub\Services\GroupsServices');
    }

    public function getPrerequestFormData()
    {
        $groupService = new \OlaHub\Services\GroupsServices;
        $return = $groupService->getPrerequestFormData();
