...
class MessageTemplatesController extends OlaHubAdminController {

    public function __construct(Request $request) {
        parent::__construct($request, 'OlaHub\Services\MessageTemplatesServices');
    }

    public function getPrerequestFormData()
    {
        $messageTemplatesService = new \OlaHub\Services\MessageTemplatesServices;
        $return = $messageTemplatesService->getPrerequestFormData();
