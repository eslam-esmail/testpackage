...
class ExchangeAndRefund extends OlahubAdminModel {
...
//        'name' => "required|max:150",
        'allow_refund' => "int:1,0",
        'allow_exchange' => "int:1,0",
    ];
    ...
    public function country() {
        return $this->belongsToMany('OlaHub\Models\Country','country_excng_refnd_plcy','policy_id','country_id');
    }
