...
class createModuleCommand extends Command {
    ...
    public function handle() {
        ...
        $moduleName = \OlaHub\Libraries\InflectLibrary::pluralize($newModuleName);
        ...
        $controllerContent = file_get_contents(base_path("templatesData/Controllers/$pluralDefaultName" . "Controller.php"));
        ...
        $trashControllerContent = file_get_contents(base_path("templatesData/Controllers/$pluralDefaultName" . "TrashController.php"));
        ...
        $modelContent = file_get_contents(base_path("templatesData/Models/$defaultName" . ".php"));
        ...
        $repoContent = file_get_contents(base_path("templatesData/Repositories/$pluralDefaultName" . "Repository.php"));
        ...
        $HandlerContent = file_get_contents(base_path("templatesData/ResponseHandler/$pluralDefaultName" . "ResponseHandler.php"));
        ...
        $RouteContent = file_get_contents(base_path("templatesData/Routes/route.php"));
        ...
        $ServiceContent = file_get_contents(base_path("templatesData/Services/$pluralDefaultName" . "Services.php"));
        ...
        $helperContent = file_get_contents(base_path("templatesData/Utilities/$pluralDefaultName" . "Helper.php"));
