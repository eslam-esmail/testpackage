...
class ExchangeAndRefundsController extends OlaHubAdminController {
    ...
    {
        $exchangeAndRefundsService = new \OlaHub\Services\ExchangeAndRefundsServices;
        $return = $exchangeAndRefundsService->getPrerequestFormData();
