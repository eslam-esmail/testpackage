...
class NewsController extends OlaHubAdminController {

    public function __construct(Request $request) {
        parent::__construct($request, 'OlaHub\Services\NewsServices');
    }

    public function getPrerequestFormData()
    {
        $newsService = new \OlaHub\Services\NewsServices;
        $return = $newsService->getPrerequestFormData();
